...
import (
	...
	"github.com/topdefi/vox-faucet/internal/chain"
	"github.com/topdefi/vox-faucet/internal/server"
)

var (
	appVersion = "v1.1.0"
	chainIDMap = map[string]int{"ropsten": 3, "rinkeby": 4, "goerli": 5, "kovan": 42, "magnavox": 1151}
